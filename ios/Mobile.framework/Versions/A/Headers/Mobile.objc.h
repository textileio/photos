...
- (instancetype)init;
// skipped field Contacts.Items with unsupported type: []*github.com/textileio/textile-go/wallet.Contact
...
- (instancetype)initWithRef:(id)ref;
- (instancetype)init;
// skipped field Devices.Items with unsupported type: []github.com/textileio/textile-go/mobile.Device
...
- (instancetype)initWithRef:(id)ref;
- (instancetype)init;
// skipped field Notifications.Items with unsupported type: []github.com/textileio/textile-go/repo.Notification
...
// skipped field Photo.Date with unsupported type: time.Time
...
// skipped field Photo.Metadata with unsupported type: *github.com/textileio/textile-go/util.PhotoMetadata
...
- (instancetype)initWithRef:(id)ref;
- (instancetype)init;
// skipped field Photos.Items with unsupported type: []github.com/textileio/textile-go/mobile.Photo
...
- (instancetype)initWithRef:(id)ref;
- (instancetype)init;
// skipped field Threads.Items with unsupported type: []github.com/textileio/textile-go/mobile.Thread
