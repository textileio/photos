...
import {
  ...
  buttonColor2,
  buttonColor4
} from '../../../Containers/Styles/InfoViewStyle'
...
const ContactModal = (props: ContactModalProps) => {
  ...
  const openTelegram = () =>
    Linking.openURL('https://t.me/joinchat/AAAAAEfVwD37Wh0OpnlXKA')
  const openTwitter = () =>
    Linking.openURL(
      'https://twitter.com/messages/compose?recipient_id=773578637320880128'
    )
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.closeIconPadding} onPress={onClose}>
            <Image
              ...
              source={require('../../../Images/v2/icon-cancel.png')}
            />
          </TouchableOpacity>
        </View>
