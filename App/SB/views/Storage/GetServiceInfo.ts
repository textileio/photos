...
export default function(service: string): StorageDescription | undefined {
  switch (service) {
    case 'autoPinPhotos':
      return {
        ...
        details:
          'Automatically sync files from your local camera roll to your Textile wallet. ' +
    ...
    case 'enablePhotoBackup':
      return {
        ...
        details:
          'Uses a remote Textile IPFS cluster to backup your privately encrypted photos.'
      }
    case 'enableWalletBackup':
      return {
        ...
        details:
          'In the event you lose, wipe, or destroy your device, this enables full wallet recovery using only your recovery phrase.'
      }
    default:
      return undefined
  }
