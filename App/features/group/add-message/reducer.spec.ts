import { addMessageReducer as reducer, addMessageActions as actions } from './'
  ...
  describe('adding message', () => {
    it('should manage async adding of messages', () => {
      const state0 = reducer(
        initialState,
        actions.addMessage.request({ id: id1, groupId: groupId1, body })
      )
      ...
      const state1 = reducer(
        state0,
        actions.addMessage.request({ id: id2, groupId: groupId1, body })
      )
      ...
      const state2 = reducer(
        state1,
        actions.addMessage.request({ id: id1, groupId: groupId2, body })
      )
      ...
      const state3 = reducer(
        state2,
        actions.addMessage.success({ id: id1, groupId: groupId1 })
      )
      ...
      const state4 = reducer(
        state3,
        actions.addMessage.success({ id: id2, groupId: groupId1 })
      )
      ...
      const state5 = reducer(
        state4,
        actions.addMessage.failure({ id: id1, groupId: groupId2, error })
      )
