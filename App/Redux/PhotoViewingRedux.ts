  ...
  addThreadRequest: createAction('ADD_THREAD_REQUEST', resolve => {
    return (
      ...
      options?: {
        ...
        sharePhoto?: { imageId: string; comment?: string }
      }
...
interface PhotoViewingState {
  ...
  readonly viewingWalletPhoto?: IFiles
  readonly viewingThreadId?: string
  readonly viewingPhoto?: IFiles
  ...
  switch (action.type) {
    case getType(actions.insertThread): {
      ...
      return {
        ...
        threads: {
          ...state.threads,
          [id]: { id, key, name, querying: false, photos: [] }
        }
      }
    }
    ...
    case getType(actions.refreshThreadSuccess): {
      ...
      let viewingPhoto: IFiles | undefined
