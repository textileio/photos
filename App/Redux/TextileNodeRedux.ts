...
const actions = {
  ...
  ignorePhotoRequest: createAction('IGNORE_PHOTO_REQUEST', resolve => {
    return (threadId: TT.ThreadId, blockId: TT.BlockId) => resolve({ threadId, blockId })
  }),
  ...
  getPhotoHashesSuccess: createAction('GET_PHOTO_HASHES_SUCCESS', resolve => {
    return (threadId: TT.ThreadId, photos: TT.Photo[]) => resolve({ threadId, photos })
  }),
  getPhotoHashesFailure: createAction('GET_PHOTO_HASHES_FAILURE', resolve => {
    return (threadId: TT.ThreadId, error: Error) => resolve({ threadId, error })
  }),
  getPhotoMetadataSuccess: createAction('GET_PHOTO_METADATA_SUCCESS', resolve => {
    return (threadId: TT.ThreadId, photoId: TT.PhotoId, metadata: TT.PhotoMetadata) => resolve({ threadId, photoId, metadata })
  }),
...
export type ThreadData = {
  ...
  readonly photos: ReadonlyArray<TT.Photo>
