...
describe('ui stories', () => {
  ...
  describe('handling invites', () => {
    ...
    it('should succeed at accepting an invite', () => {
      ...
      const state1 = reducer(state0, actions.acceptExternalInviteSuccess(inviteId))
      const match1 = [{ inviteId, inviteKey }]
    ...
    it('should ignore out of order events', () => {
      ...
      const state2 = reducer(initialState, actions.acceptExternalInviteSuccess(inviteId))
