  ...
  describe('tracking upload state', () => {
    it('should add a photo', () => {
      const state0 = reducer(
        initialState,
        actions.addImage(path, dataId, attempts)
      )
    ...
    it('should track upload progress', () => {
      ...
      const state1 = reducer(
        state0,
        actions.imageUploadProgress(dataId, uploadProgress)
      )
    ...
    it('should track upload complete', () => {
      ...
      const state3 = reducer(
        state1,
        actions.imageUploadComplete(dataId, responseCode, responseBody)
      )
    ...
    it('should track an upload error', () => {
      ...
      const state2 = reducer(
        state1,
        actions.imageUploadError(dataId, errorMessage)
      )
