...
public class TextileImageTask extends AsyncTask<Void, Void, Bitmap> {
    ...
    public TextileImageTask(int viewId, RCTEventEmitter eventEmitter, String imageId, int minWidth, ImageView imageView) {
        this.viewId = viewId;
    ...
    protected Bitmap doInBackground(Void... params) {
        try {
            JSONObject imageJson = new JSONObject(TextileNode.node.getPhotoDataForMinWidth(this.imageId, this.minWidth));
